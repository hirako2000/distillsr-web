    ...
    <div class="flex items-center gap-4">
        <div class="relative min-w-[100px]">
            <select :value="modelValue" @change="$emit('update:modelValue', $event.target.value)"
                class="w-full px-5 py-1 md:py-2 bg-white/5 border border-white/10 rounded-2xl text-white text-sm appearance-none cursor-pointer hover:bg-white/10 focus:outline-none focus:border-purple-500 focus:ring-3 focus:ring-purple-500/20 transition-all">
        ...
        <div class="flex items-center gap-1 md:gap-3 px-2 md:px-4 py-1 md:py-2 bg-white/5 rounded-full border border-white/10">
